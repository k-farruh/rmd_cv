...
if (!file.exists(file_path_experience) | is_write) {
    df_experience <- tribble(
        ...
        "Senior Data Scientist", "Midea HBT", "November", 2020, "April", 2022, "Foshan, China", "The work mainly involves data-driven predictive control, predictive maintenance, fault diagnosis, behavior pattern analysis, etc.",
        "Senior Data Scientist", "Midea HBT", "November", 2020, "April", 2022, "Foshan, China", "Carry out including experimental design, data collection, data analysis, model building, model verification, model deployment, continuous Iteration, and other aspects of work",
        "Senior Data Scientist", "Midea HBT", "November", 2020, "April", 2022, "Foshan, China", "Complete the data modeling analysis report, and carry out technical precipitation",
        "Senior Data Scientist", "Midea HBT", "November", 2020, "April", 2022, "Foshan, China", "Read relevant literature and keep up with the latest developments in data science and business",
        "Senior Data Scientist", "Midea HBT", "November", 2020, "April", 2022, "Foshan, China", "Interview the potential candidates for the data scientist team",
        # TutorABC
