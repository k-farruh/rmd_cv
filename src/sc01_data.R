...
if (!file.exists(file_path_experience)) {
    ...
    ",
        ...
        "Head of the department information technologies and associate professor", "Tashkent Railway Engineering Institute", "March", 2016, "April", 2016, "Tashkent, Uzbekistan", "The introduction of advanced computer curriculum imporovement theory.",
        "Head of the department information technologies and associate professor", "Tashkent Railway Engineering Institute", "March", 2016, "April", 2016, "Tashkent, Uzbekistan", "Advocating paperless examination and aproval.",
        # Domus Sapiens
